# N-MAGMA
T-MAGMA is an approach to intergrate Hi-C, eQTL and TOM matrix of gene expression calculated by WGCNA into default physical location mapping based MGAMA annotation.
## List of files
